...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		translate:{
			"xinfu_lingren":"凌人",
			"xinfu_lingren_info":"每回合限一次。当你于出牌阶段内使用带有「伤害」这一标签的基本牌或普通锦囊牌指定目标后，你可以猜测其中的一个目标的手牌中是否有基本牌，锦囊牌或装备牌。若你猜中的项目数：≥1，此牌对该角色的伤害+1；≥2，你摸两张牌；≥3，你获得技能〖奸雄〗和〖行殇〗直到下回合开始。",
			...
			"new_zhixi":"止息",
			"new_zhixi_info":"锁定技，出牌阶段内，你至多可使用X张牌，你使用了锦囊牌后不能再使用牌（X为你的体力值）。",
			"new_mumu2":"穆穆",
			...
			fengpo:'凤魄',
			fengpo_info:'当你于出牌阶段内第一次使用【杀】或【决斗】指定目标后，若目标角色数为1，你可以选择一项：1.摸X张牌；2.令此牌的伤害值基数+X。（X为其手牌中♦牌的数量）',
			chenqing:'陈情',
			...
			jinzhi:'锦织',
			jinzhi2:'锦织',
			jinzhi_info:'当你需要使用或打出一张基本牌时，你可弃置X张牌并摸一张牌。若你以此法弃置的牌均为同一颜色，则视为你使用或打出了此牌。（X为你于本轮内开始发动此技能的次数）',
			yanxiao_card:'言笑',
			yanxiao_global:'言笑',
