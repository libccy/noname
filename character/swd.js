...
character.swd={
	...
	translate:{
		...
		hyunshen:'云身',
		hyunshen2:'云身',
		hyunshen_info:'每当你打出一张闪，你可以令其他角色与你的距离+1；准备阶段，你将累计的防御距离清零，然后摸等量的牌',
		hlingbo:'凌波',
		...
		kongmo:'恐魔',
		kongmo_info:'锁定技，你使用基本牌或通常锦囊牌后将额外结算一次卡牌效果',
		jufu:'巨斧',
		...
		jikong:'亟空',
		jikong2:'亟空',
		jikong_info:'当你失去最后一张手牌，或在准备阶段时，你可以指定一名角色视为对其使用一张雷杀',
		xiangu:'仙骨',
		...
		xuanzhou:'玄咒',
		xuanzhou_info:'出牌阶段限一次，你可以将一张通常锦囊牌当作任意一张延时锦囊，对任意一名角色使用（无视锦囊使用范围限制）',
		ningxian:'凝霰',
