const translates = {
	...
	huan_zhugeguo_A: "技一",
	huan_zhugeguo_A_info: "①出牌阶段限三次，你可以将至多两张牌标记为“技一”并交给一名本轮未以此法交给其牌的角色。②拥有“技一”标记牌的角色的出牌阶段开始时，你可以观看其手牌并将其中至多X张牌以任意顺序置于牌堆顶（X为你本局游戏发动〖技一〗交给其的牌数）。③回合开始时，你移去所有角色手牌中的“技一”标记，然后摸等量的牌。",
	huan_zhugeguo_B: "技二",
	huan_zhugeguo_B_info: "当你成为普通锦囊牌的目标时，你可以展示牌堆顶的一张牌，若此牌与使用的牌的：颜色相同，你获得此牌；花色相同，你令此牌对你无效；颜色不同，你将此牌置入弃牌堆。",
	huan_jiangwei: "幻姜维",
