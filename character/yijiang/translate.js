const translates = {
	...
	dc_majun_prefix: "新杀",
	dcgongqiao: "工巧",
	dcgongqiao_info: "出牌阶段限一次，你可将一张手牌置入一个装备栏（替换原装备）；若你的装备区内有：基本牌，你使用基本牌数值+1；锦囊牌，你每回合首次使用一种类型的牌后摸一张牌；装备牌，手牌上限+3。",
	dcjingyi: "精益",
	dcjingyi_info: "锁定技，有牌进入你的装备区后，你摸X张牌，然后弃置两张牌（X为你装备区里的牌数）。",
};
