const translates = {
	...
	dc_sb_guojia: "新杀谋郭嘉",
	dc_sb_guojia_prefix: "新杀谋",
	dcxianmou: "先谋",
	dcxianmou_info: "转换技，你失去过牌的回合结束时，你可以：阴，观看牌堆顶五张牌并获得至多X张牌，若未获得X张牌则获得〖遗计〗直到再发动此项；阳，观看一名角色手牌并弃置其中至多X张牌，若弃置X张牌则你进行一次【闪电】判定。（X为你本回合失去牌数）",
	dclunshi: "论势",
	dclunshi_info: "一名角色对其以外的角色使用普通锦囊牌的结算中，若你手牌中两张颜色的牌数量相同，你可将一张手牌当作不可被响应的【无懈可击】使用。",
};
