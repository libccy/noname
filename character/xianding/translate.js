const translates = {
	...
	dcsbyaozuo: "邀作",
	dcsbyaozuo_info: "出牌阶段限一次，你令所有其他角色同时选择是否交给你一张牌，未交给你牌的角色，本回合你对其下次造成伤害+1；然后你令最快交给你牌的角色选择另一名其他角色，你对该角色发动一次〖缀文〗。",
	dcsbzhuiwen: "缀文",
	dcsbzhuiwen_info: "结束阶段，你可选择一名其他角色，展示牌堆顶X张牌并选择一项：1.对其使用其中的伤害牌；2.令其获得其中的非伤害牌。然后将剩余牌置于牌堆顶（X为其手牌数且至多为5）。",
};
