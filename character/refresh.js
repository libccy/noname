...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		translate:{
			...
			xinleiji_misa:'雷击',
			xinguidao:'鬼道',
			xinleiji_info:'①当你使用或打出【闪】或使用【闪电】时，你可以进行判定。②当你的判定的判定牌生效后，若结果为：黑桃，你可对一名其他角色造成2点雷电伤害；梅花：你回复1点体力并可对一名其他其他角色造成1点雷电伤害。',
			...
			rezishou:'自守',
			rezishou2:'自守',
			rezishou_info:'摸牌阶段，你可以多摸X张牌（X为现存势力数）。若如此做，本回合你对其他角色造成伤害时，防止此伤害。',
			rezongshi:'宗室',
			rezongshi_info:'锁定技，你的手牌上限+X（X为现存势力数）。准备阶段，若你的手牌数大于体力值，则你本回合内使用【杀】无次数限制。',
			ol_dongzhuo:'界董卓',
			olbaonue:'暴虐',
			...
			decadezishou_info:'摸牌阶段，你可以多摸X张牌（X为现存势力数）,然后本回合你对其他角色造成伤害时，防止此伤害。结束阶段，若你本回合没有使用牌指定其他角色为目标，你可以弃置任意张花色不同的手牌，然后摸等量的牌。',
			decadezongshi:'宗室',
			...
			re_guyong:'界顾雍',
			reshenxing:'慎行',
			reshenxing_info:'出牌阶段，你可以弃置X张牌（X为你本阶段内此前发动过〖慎行〗的次数且至多为2, 若X为0, 则不弃），然后摸一张牌。',
			rebingyi:'秉壹',
