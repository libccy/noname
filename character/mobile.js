...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		translate:{
			...
			wanlan:'挽澜',
			wanlan_info:'限定技，当一名角色进入濒死状态时，你可以弃置所有手牌(无牌则不弃)并令其回复体力至1点，然后对当前回合角色造成1点伤害。',
			re_jikang:"手杀嵇康",
			old_caochun:'旧曹纯',
			shenpei:'审配',
			re_wangyun:'手杀王允',
			...
			reqingce:'清侧',
			reqingce_backup:'清侧',
			rezhengrong_info:'当你于出牌阶段内使用的指定了其他角色为目标的牌结算完成后，若此牌是你本局游戏内于出牌阶段内使用的指定了其他角色为目标的第偶数张牌，则你可以将一名其他角色角色的随机一张牌置于你的武将牌上，称为「荣」。',
			...
			liyong2:'厉勇',
			liyong3:'厉勇',
			liyong_info:'锁定技，若你于出牌阶段内使用的【杀】被【闪】抵消，本阶段你下一张【杀】不可被响应且伤害+1，指定的目标本回合非锁定技失效，当此【杀】造成伤害后，若目标角色未死亡，你失去1点体力。',
			gongsunkang:'公孙康',
			juliao:'据辽',
			...
			xin_zhoucang:'手杀周仓',
			mobilezhongyong:'忠勇',
			mobilezhongyong_info:'当你于出牌阶段内使用【杀】结算结束后，若没有目标角色使用【闪】响应过此【杀】，则你可获得此【杀】；否则你可选择一项：①获得目标角色使用的【闪】，然后可将此【杀】交给另一名其他角色。②将目标角色使用的【闪】交给另一名其他角色，然后你本回合使用【杀】的次数上限+1且下一张【杀】的伤害值基数+1。（你不能使用本回合因执行〖忠勇〗的效果获得的牌）',
			mjdingyi:'定仪',
			...
			zhangzhongjing:'张机',
			jishi:'济世',
			jishi_info:'锁定技。①当你使用的基本牌或普通锦囊牌结算完成后，若你未因此牌造成过伤害，则你将此牌对应的所有实体牌置于仁库中。②当有牌不因溢出而离开仁库时，你摸一张牌。',
			liaoyi:'疗疫',
			...
			sp_gaolan:'手杀高览',
			spjungong:'峻攻',
			spjungong_info:'出牌阶段，你可失去X点体力或弃置X张牌，视为对一名其他角色使用【杀】（不计入次数和距离限制，X为你本回合内之前发动过〖等力〗的次数+1）。若你因此【杀】造成了伤害，则你令此技能失效直到回合结束。',
			spdengli:'等力',
