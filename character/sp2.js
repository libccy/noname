...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		translate:{
			...
			fanyufeng:'樊玉凤',
			bazhan:'把盏',
			bazhan_info:'转换技，出牌阶段限一次，阴：你可以将至多两张手牌交给一名其他角色。阳：你可以获得一名其他角色的至多两张手牌。若以此法移动的牌在得到牌的角色的手牌区中牌名包含【酒】或花色包含红桃，则你可令得到牌的角色执行一项：①回复1点体力。②复原武将牌。',
			jiaoying:'醮影',
			jiaoying2:'醮影',
			jiaoying3:'醮影',
			jiaoying3_draw:'醮影',
			...
			chengui:'陈珪',
			dcyingtu:'营图',
			dcyingtu_info:'每回合限一次。当你的上家/下家于摸牌阶段外获得牌后，你可以获得其一张牌，然后将一张牌交给你的下家/上家。若你给出的牌在其手牌区为装备牌，则其使用之。',
			dccongshi:'从势',
