const translates = {
	...
	tychengshi: "乘势",
	tychengshi_info: "锁定技，每回合限一次，当你于回合内/回合外使用红色【杀】造成伤害后，你令此牌不计入次数/令受伤角色此阶段不能使用伤害类牌指定你以外的角色为目标。",
	tyfuwei: "抚危",
	...
	ty_liubei_prefix: "龙",
	tyqingshi: "倾师",
	tyqingshi_info: "准备阶段，你可令至多你体力值名角色进行议事，若议事结果为：红色，本轮意见为红色的角色各与其以外的角色互相计算距离+1；黑色，你摸意见为黑色的角色数张牌，然后你可以交给这些角色各一张牌。",
	tyyilin: "夷临",
