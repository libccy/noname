const translates = {
	scl_zhenji: "SCL甄宓",
	scl_zhenji_prefix: "SCL",
	scl_maliang: "SCL马良",
	scl_maliang_prefix: "SCL",
	...
	scls_luoshen: "洛神",
	scls_luoshen_info: "准备阶段，你可以进行判定，若结果为黑色，你获得此判定牌且本回合的手牌上限+1，然后你可以重复此流程。",
	scls_luoshen_info_guozhan: "准备阶段，你可以进行判定，若结果为黑色则本回合的手牌上限+1并可以继续判定，直到出现红色。然后你获得所有黑色的判定牌。",
	scls_zishu: "自书",
	scls_zishu_info: "锁定技，当你于回合内非以此法获得手牌后，你摸一张牌；其他角色的结束阶段，你将本回合获得的手牌置入弃牌堆。",
	scls_yingyuan: "应援",
	scls_yingyuan_info: "每回合每种类型的牌限一次，当你于回合内使用的基本牌或普通锦囊牌结算完成后，你可以将之交给一名其他角色。",
	scls_yinshi: "隐士",
	...
	jd_sb_sp_zhugeliang: "鼎诸葛亮",
	jd_sb_sp_zhugeliang_prefix: "鼎",
	jdhuoji: "火计",
	...
	jd_sb_caocao: "鼎曹操",
	jd_sb_caocao_prefix: "鼎",
	jdjianxiong: "奸雄",
	jdjianxiong_info: "①游戏开始时，你可获得至多2枚“治世”标记。②当你受到伤害后，你可获得伤害牌，摸2-X张牌（X为“治世”数），然后你可以移去1枚“治世”。",
	jd_jin_simazhao: "鼎司马昭",
	jd_jin_simazhao_prefix: "鼎",
	jd_jin_xiahouhui: "鼎夏侯徽",
	jd_jin_xiahouhui_prefix: "鼎",
	jdbaoqie: "宝箧",
	...
	jd_sb_huangyueying: "鼎黄月英",
	jd_sb_huangyueying_prefix: "鼎",
	jdjizhi: "集智",
