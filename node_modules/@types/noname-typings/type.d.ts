...
type TriggerEvent = 'yingbianZhuzhan' | 'replaceEquip' |
    'debateCallback' | /** 每个技能名对应一个事件 */'【skill】' |
    'name_Cancel' | 'pre_【skill】' | 'compareMultiple' |
...
//所有的信号
type Signal = TriggerEventSinal | TriggerSignal | (string & {})
