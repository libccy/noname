...
type Signal_Trigger = 'addShownCardsAfter' | 'addToExpansionBefore' | 'boss_baonuwash' | 'cangchuAwaken' |
    'changeHp' | 'changeSkillsAfter' | 'changeSkillsBefore' | 'changeSkillsBegin' | 'changeSkillsEnd' | 'compare' | 'compareCardShowBefore' | 'compareFixing' | 'damage' | 'damageBefore' | 'damageBegin1' | 'damageBegin2' | 'damageBegin3' | 'damageBegin4' | 'damageSource' | 'damageZero' | 'dchuoxin_update' | 'debateShowOpinion' | 'die' | 'discard' | 'dying' | 'enterGame' | 'eventNeutralized' | 'executeDelayCardEffect' | 'fellow' | 'gameStart' | 'gift' | 'giftAccept' | 'giftAccepted' | 'giftDenied' | 'giftDeny' | 'hideShownCardsAfter' | 'humeng_yanjia' | 'jiananUpdate' | 'judge' | 'judgeFixing' | 'juedou' | 'loseToDiscardpile' | 'mbquchongOnRemove' | 'mouchengAwaken' | 'phaseAfter' | 'phaseBefore' | 'phaseBeforeEnd' | 'phaseBeforeStart' |
    'phaseBegin' | 'phaseBeginStart' | 'phaseChange' | 'phaseDiscard' | 'phaseDrawBegin1' | 'phaseDrawBegin2' |
    'phaseEnd' | 'phaseJudge' | 'phaseOver' | 'phaseUseAfter' | 'phaseUseBefore' | 'phaseUseBegin' |
    'phaseUseEnd' | 'recast' | 'recastingGain' | 'recastingGained' | 'recastingLose' | 'recastingLost' |
    'remoucheng_awaken' | 'removeCharacterBefore' | 'removeSubPlayer' | 'respond' | 'restEnd' |
    'rewriteDiscardResult' | 'rewriteGainResult' | 'roundStart' | 'shaBefore' | 'shaDamage' | 'shaHit' |
    'shaMiss' | 'shaUnhirt' | 'showCharacterAfter' | 'showCharacterEnd' | 'skillAfter' | 'subPlayerDie' |
    'triggerAfter' | 'triggerHidden' | 'triggerInvisible' | 'useCard' | 'useCard0' | 'useCard1' | 'useCard2' |
    'useCardToBefore' | 'useSkill' | 'washCard' | 'wuguRemained' | 'yingbian' | 'zhengjun' | 'zhuUpdate';


//所有的带额外时机的事件汇总
type EventWithTrigger = `equip_[equipname]` | `lose_${_ALLCardName}` | 'pre_[skillname]' | `${_ALLCardName}Cancel` |
    '[skillname]_cost' | '_save' | 'addFellowAuto' | 'addJudge' | 'addToExpansion' | 'boss_jingjia' | 'callSubPlayer' | 'caochuan_gain' | `${_ALLCardName}ContentAfter` | `${_ALLCardName}ContentBefore` | `${_ALLCardName}` | 'cardsDiscard' | 'cardsGotoOrdering' | 'cardsGotoPile' | 'cardsGotoSpecial' | 'carryOutJunling' | 'changeCharacter' | 'changeGroup' | 'changeHp' | 'changeHujia' | 'changeVice' | 'chessMech' | 'chessMechRemove' | 'chooseBool' | 'chooseButton' | 'chooseButtonOL' | 'chooseCard' | 'chooseCardOL' | 'chooseCardTarget' | 'chooseCharacter' | 'chooseCharacterOL' | 'chooseControl' | 'chooseCooperationFor' | 'chooseJunlingControl' | 'chooseJunlingFor' | 'choosePlayerCard' | 'chooseSkill' | 'chooseTarget' | 'chooseToCompare' | 'chooseToDebate' | 'chooseToDisable' | 'chooseToDiscard' | 'chooseToDuiben' | 'chooseToEnable' | 'chooseToGive' | 'chooseToGuanxing' | 'chooseToMove' | 'chooseToMoveChess' | 'chooseToMove_new' | 'chooseToPSS' | 'chooseToPlayBeatmap' | 'chooseToRespond' | 'chooseToUse' | 'chooseUseTarget' | 'compareMultiple' | 'damage' | 'dcqingshi_after' | 'die' | 'disableEquip' | 'disableJudge' | 'discard' | 'discardPlayerCard' | 'discoverCard' | 'doubleDraw' | 'draw' | 'dying' | 'enableEquip' | 'enableJudge' | 'equip' | '[skillname]' | '[skillname]ContentAfter' | '[skillname]ContentBefore' | 'executeDelayCardEffect' | 'exitSubPlayer' | 'expandEquip' | 'finish_game' | 'fulu_clear' | 'gain' | 'gainMaxHp' | 'gainPlayerCard' | 'game' | 'gameDraw' | 'gift' | 'guozhanDraw' | 'gzzhenxi_use' | 'hideCharacter' | 'huituo' | 'jiyu_clear' | 'jsprende_clear' | 'judge' | 'junkguixinx' | 'lihuo_clear' | 'link' | 'loadMap' | 'loadPackage' | 'lose' | 'loseAsync' | 'loseHp' | 'loseMaxHp' | 'loseToDiscardpile' | 'mayChangeVice' | 'mbdanggu_clique' | 'moveCard' | 'name' | 'name + "Cancel"' | 'nsxianhai_clear' | 'nvzhuang_lose' | 'olsaogu_chooseToUseSha' | 'phaseDiscard' | 'phaseDraw' | 'phaseJieshu' | 'phaseJudge' | 'phaseLoop' | 'phaseZhunbei' | 'psjianwei_swap' | 'qinglong_guozhan' | 'recast' | 'recover' | 'removeCharacter' | 'replaceChessPlayer' | 'replaceEquip' | 'replaceHandcards' | 'replacePlayer' | 'rerende_clear' | 'respond' | 'rexingshuai_next' | 'showCards' | 'showHandcards' | 'spjiedao_after' | 'stratagemCamouflage' | 'stratagemInsight' | 'swapEquip' | 'taoluan_clear' | 'tenzen_retianqua_gain' | 'toggleSubPlayer' | 'turnOver' | 'twfuzuan' | 'twmouli_update' | 'twqingtao' | 'twtijin_discard' | 'useCard' | 'useSkill' | 'versusDraw' | 'viewCards' | 'viewCharacter' | 'wuling_change' | 'xingshuaI_next' | 'xintaoluan_clear' | 'yashi_guanxu' | 'yingbianEffect' | 'yingbianZhuzhan' | 'yise_insert' | 'zhuque_clear';


//所有的不带额外时机的事件汇总,即game.createEvent(xxx,false)中含有false参数的。
type EventWithoutTrigger = '[eventname]Inserted' | 'addShownCards' | 'arrangeTrigger' | 'changeSkills' | 'chooseDrawRecover' | 'congjian_draw' | 'dchuagui_choose' | 'dcsitian_weather' | 'dddfenye_choose' | 'debateCallback' | 'delay' | 'delayx' | 'dieAfter' | 'enterGame' | 'gainMultiple' | 'game' | 'gouzhu_effect' | 'hideShownCards' | 'iriya_haozhi_effect' | 'jdyanxi' | 'jsrghuozhong_draw' | 'judgeCallback' | 'kuiji_content' | 'leaderView' | 'limu_recover' | 'loadMode' | 'logSkill' | 'logSkillBegin' | 'ollangdao_choose' | 'olzhenying_adjust' | 'orderingDiscard' | 'phase' | 'phaseUse' | 'qianlidanji_replace' | 'qingjiao_discard' | 'reguhuo_final' | 'renxia_discard' | 'renxia_draw' | 'replacePlayer' | 'replacePlayerSingle' | 'replacePlayerTwo' | 'saya_powei_loop' | 'shidianyanluo_huanren' | 'showCharacter' | 'showYexings' | 'swapHandcards' | 'trigger' | 'useCardToExcluded' | 'useCardToPlayer' | 'useCardToPlayered' | 'useCardToTarget' | 'useCardToTargeted' | 'video' | 'waitForPlayer' | 'wuxianhuoli_reward' | 'yanxi' | 'year_limit_pop';
...
//【最终的所有的总的信号】 = 【由事件派生的】 + 【event.trigger()手动触发的】
