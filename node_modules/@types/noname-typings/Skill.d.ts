...
declare interface Mod {
	 ...
	 * 卡牌能否主动弃置
	 */
	cardDiscardable?(card: Card, player: Player, eventName: string): boolean | void;
	/**
	 * 卡牌是否可用(卡牌能否被选择)
	 * 比cardEnabled2更弱一些
	 * 
	...
	/**卡牌能否被重铸 */
	cardRecastable(card: Card, player: Player, source: Player): boolean | void
	/**
	 * 卡牌是否可用（改变卡牌的使用次数）
	 * 
