export class Player extends HTMLDivElement {
    ...
    /**
     * 返回玩家本回合使用某个技能的次数，若为出牌阶段的主动技则返回当前阶段的发动次数
     * @param { string } skill
     * @returns { number }
     */
     ...
     */
    addTempSkill(skill: string | string[], expire?: string | SkillTrigger | ((event: GameEventPromise, player: Player, name: string) => boolean), checkConflict?: boolean): any;
