export class Player extends HTMLDivElement {
     ...
     */
    iterableGetGainableCards(player: Parameters<(card: any, player: any, target: any, event: any) => any>[1], arg1: Parameters<this["iterableGetCards"]>[0], arg2: Parameters<this["iterableGetCards"]>[1]): Generator<any, void, unknown>;
    /**
     *
     ...
     * @param { boolean } [logv]
     */
    logSkill(name: string | string[], targets?: Player | Player[], nature?: boolean | string, logv?: boolean, special: any): void;
    unprompt(): void;
    ...
    addTempSkills(skillsToAdd: any, expire: any): import("./gameEvent.js").GameEvent;
    /**
     * @overload
     * @param { string } skill
     ...
     * @param { boolean } [checkConflict]
     */
    addTempSkill(skill: string, expire?: SkillTrigger | string | ((event: GameEventPromise, player: Player, name: string) => boolean), checkConflict?: boolean): any;
    /**
     * @overload
     * @param { string } skill
     * @param { SkillTrigger | string | (event:GameEventPromise, player:Player, name:string) => boolean } [expire]
     ...
     * @param { GameEventPromise } [last]
     */
    checkHistory<T extends keyof ActionHistory>(key: T, filter: (event: GameEventPromise) => boolean, last?: GameEventPromise): void;
    /**
     * @template { keyof ActionHistory } T
     * @param { T } key
     * @param { (event: GameEventPromise) => boolean } [filter]
     ...
     * @returns { boolean }
     */
    hasHistory<T extends keyof ActionHistory>(key: T, filter?: (event: GameEventPromise) => boolean, last?: GameEventPromise): boolean;
    /**
     * @template { keyof ActionHistory } T
     * @overload
     * @param { T } [key]
     ...
     */
    getLastHistory<T extends keyof ActionHistory>(key?: T, filter?: (event: GameEventPromise) => boolean, last?: GameEventPromise): null | ActionHistory[T] | boolean;
    /**
     * @template { keyof ActionHistory } T
     * @param { T } key
     * @param { (event: GameEventPromise) => boolean } filter
     * @param { GameEventPromise } [last]
     */
    checkAllHistory<T extends keyof ActionHistory>(key: T, filter: (event: GameEventPromise) => boolean, last?: GameEventPromise): void;
    /**
     * @template { keyof ActionHistory } T
     * @param { T } [key]
     * @param { (event: GameEventPromise) => boolean } [filter]
     ...
     * @returns { ActionHistory[T] }
     */
    getAllHistory<T extends keyof ActionHistory>(key?: T, filter?: (event: GameEventPromise) => boolean, last?: GameEventPromise): ActionHistory[T];
    /**
     * @template { keyof ActionHistory } T
     * @param { T } key
     * @param { (event: GameEventPromise) => boolean } filter
     ...
     * @returns { boolean }
     */
    hasAllHistory<T extends keyof ActionHistory>(key: T, filter: (event: GameEventPromise) => boolean, last?: GameEventPromise): boolean;
