export class GameEvent {
    ...
    neutralize(event?: import("noname-typings/nonameModules/noname/library/element/gameEvent.js").GameEvent): Promise<Result & {
        result: Result;
    }>;
    /**
     * @type { boolean }
     ...
     */
    then<TResult1, TResult2>(onfulfilled?: ((event: Result & {
        result: Result;
    }) => TResult1 | Promise<TResult1>) | null, onrejected?: ((reason: any) => TResult2 | Promise<TResult2>) | null): Promise<TResult1 | TResult2>;
    resolve(): void;
    start(): Promise<void>;
    resolved: boolean;
    loop(): Promise<void>;
