...
export class GameEvent implements PromiseLike<Omit<GameEvent, "then">> {
     ...
     */
    then<TResult1, TResult2>(onfulfilled?: ((event: Omit<GameEvent, "then">) => TResult1 | Promise<TResult1>) | null, onrejected?: ((reason: any) => TResult2 | Promise<TResult2>) | null): Promise<TResult1 | TResult2>;
    /**
     * @template TResult
     ...
     */
    catch<TResult>(onrejected?: ((reason: any) => TResult | Promise<TResult>) | null): Promise<Omit<GameEvent, "then"> | TResult>;
    /**
