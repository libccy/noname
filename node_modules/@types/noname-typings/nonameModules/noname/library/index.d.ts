export class Library {
    ...
    getUTC(date: any): any;
    saveVideo(): void;
    genAsync(fn: any): (...args: Parameters<GeneratorFunction>) => Promise<ReturnType<GeneratorFunction>>;
    genAwait(item: any): Promise<any>;
    gnc: {
        of: (fn: any) => (...args: Parameters<GeneratorFunction>) => Promise<ReturnType<GeneratorFunction>>;
        is: {
    ...
    element: {
        ...
        contents: SMap<((event: globalThis.GameEventPromise, trigger: globalThis.GameEventPromise, player: globalThis.Player) => Promise<any>)[]>;
    ...
    filter: {
        ...
        selectCard: () => number[];
        selectTarget: (card: any, player: any) => number | (() => number | Select) | number[];
