export class Game extends GameCompatible {
     ...
     * @param { GameEvent } [event]
     */
    runContent(event?: GameEvent): any;
    pause(): void;
    pause2(): void;
    resume(): void;
    resume2(): void;
    delaye(...args: any[]): import("../library/element/gameEvent.js").GameEvent;
    delayex(...args: any[]): import("../library/element/gameEvent.js").GameEvent;
    /**
     * @param { number } [time]
     * @param { number } [time2]
     */
