export class Game extends GameCompatible {
     ...
     * @returns { void }
     */
    broadcast<T_6 extends "exec" | "log" | "opened" | "onconnection" | "onmessage" | "onclose" | "selfclose" | "reloadroom" | "createroom" | "enterroomfailed" | "roomlist" | "updaterooms" | "updateclients" | "updateevents" | "eventsdenied" | "init" | "reinit" | "denied" | "cancel" | "closeDialog" | "createDialog" | "gameStart" | "updateWaiting">(func: T_6, ...args: Parameters<{
        log: (arr: any) => void;
        opened: () => void;
     ...
     * @returns { void }
     */
    broadcast<T_6 extends "exec" | "log" | "opened" | "onconnection" | "onmessage" | "onclose" | "selfclose" | "reloadroom" | "createroom" | "enterroomfailed" | "roomlist" | "updaterooms" | "updateclients" | "updateevents" | "eventsdenied" | "init" | "reinit" | "denied" | "cancel" | "closeDialog" | "createDialog" | "gameStart" | "updateWaiting">(func: (...args: T_6) => void, ...args: T_6): void;
    /**
     * @template { keyof typeof lib.message.client } T
     * @overload
     * @param { T } func
     ...
     * @returns { void }
     */
    broadcastAll<T_7 extends "exec" | "log" | "opened" | "onconnection" | "onmessage" | "onclose" | "selfclose" | "reloadroom" | "createroom" | "enterroomfailed" | "roomlist" | "updaterooms" | "updateclients" | "updateevents" | "eventsdenied" | "init" | "reinit" | "denied" | "cancel" | "closeDialog" | "createDialog" | "gameStart" | "updateWaiting">(func: T_7, ...args: Parameters<{
        log: (arr: any) => void;
        opened: () => void;
        onconnection: (id: any) => void;
        onmessage: (id: any, message: any) => void;
     ...
     * @returns { void }
     */
    broadcastAll<T_7 extends "exec" | "log" | "opened" | "onconnection" | "onmessage" | "onclose" | "selfclose" | "reloadroom" | "createroom" | "enterroomfailed" | "roomlist" | "updaterooms" | "updateclients" | "updateevents" | "eventsdenied" | "init" | "reinit" | "denied" | "cancel" | "closeDialog" | "createDialog" | "gameStart" | "updateWaiting">(func: (...args: T_7) => void, ...args: T_7): void;
    syncState(): void;
    updateWaiting(): void;
    /**
     * @param { Function } func
    ...
    pause(): {
        "__#2@#promise": Promise<void>;
        "__#2@#resolver": () => void;
        readonly isStarted: boolean;
        start(): void;
        resolve(): void;
        then(onfulfilled?: (value: void) => void | PromiseLike<void>, onrejected?: (reason: any) => PromiseLike<never>): Promise<void>;
    };
    pause2(): {
        "__#2@#promise": Promise<void>;
        "__#2@#resolver": () => void;
