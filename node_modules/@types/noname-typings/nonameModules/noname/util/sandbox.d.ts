...
export class Rule {
     ...
     * @param {Rule} thiz
     */
    static "__#5@#assertOperator": (thiz: Rule) => void;
    /**
     * ```plain
     * 创建一个封送规则
     * ```
...
export class Monitor {
    /** @type {Set<Monitor>} */
    static "__#9@#monitorSet": Set<Monitor>;
    /**
     * ```plain
     * 检查当前是否是 Monitor 所属的运行域
     * ```
     ...
     * @param {Monitor} thiz
     */
    static "__#9@#assertOperator": (thiz: Monitor) => void;
    /**
     * ```plain
     ...
     * @param {Monitor} thiz
     */
    static "__#9@#exposeInfo": (thiz: Monitor) => Set<any>[];
    /**
     * ```plain
     ...
     */
    static "__#9@#handle": (thiz: Monitor, access: number, nameds: {
        target: any;
        thisArg?: any;
        arguments?: Array<any>;
        newTarget?: Function;
...
export class Marshal {
    static "__#10@#revertTarget": symbol;
    static "__#10@#sourceDomain": symbol;
    static "__#10@#marshalRules": WeakMap<object, any>;
    static "__#10@#marshalledProxies": WeakSet<object>;
    /**
     * ```plain
     * 判断是否应该封送
     * ```
     ...
     * @returns {boolean}
     */
    static "__#10@#shouldMarshal": (obj: any) => boolean;
    /**
     * ```plain
     * 判断是否禁止封送
     * ```
     ...
     * @returns {boolean}
     */
    static "__#10@#strictMarshal": (obj: any) => boolean;
    /**
     * ```plain
     * 拆除封送代理
     * ```
     ...
     * @returns {Reverted}
     */
    static "__#10@#revertProxy": (proxy: any) => [Domain, any];
    /**
     * ```plain
     * 检查封送缓存
     * ```
     ...
     * @returns {Object?}
     */
    static "__#10@#cacheProxy": (obj: any, domain: Domain) => any | null;
    /**
     * ```plain
     * 获取指定对象的封送规则引用
     * ```
     ...
     * @returns {{rule: Rule}}
     */
    static "__#10@#ensureRuleRef": (obj: any) => {
        rule: Rule;
    };
    /**
     * ```plain
     ...
     * @param {() => any} action
     */
    static "__#10@#trapDomain": (domain: Domain, action: () => any) => any;
    /**
     * ```plain
     * 封送数组
     * ```
     ...
     * @returns {Array}
     */
    static "__#10@#marshalArray": (array: any[], targetDomain: Domain) => any[];
    /**
     * ```plain
     * 封送对象
     * ```
     ...
     * @returns {Object}
     */
    static "__#10@#marshalObject": (object: any, targetDomain: Domain) => any;
    /**
     * ```plain
     * 根据目标对象的特征复制一个基本对象
     * ```
     ...
     * @returns {any}
     */
    static "__#10@#clonePureObject": (src: any) => any;
    /**
     * ```plain
     * 封送核心函数
     * ```
     ...
     * @returns {Object}
     */
    static "__#10@#marshal": (obj: any, targetDomain: Domain) => any;
    /**
     * @param {Symbol} signal
     * @param {...any} args
     */
 ...
 */
export class Domain {
    static "__#11@#hasInstance": (value: any) => boolean;
    /** @type {Array<Domain>} */
    static "__#11@#domainStack": Array<Domain>;
    /** @type {Domain} */
    static "__#11@#currentDomain": Domain;
    /** @type {Domain} */
    static "__#11@#topDomain": Domain;
     ...
     * @param {Domain} domain
     */
    static "__#11@#enterDomain": (domain: Domain) => void;
    static "__#11@#exitDomain": () => void;
    /**
     * @returns {Array<Domain>}
     */
    static "__#11@#listDomain": () => Array<Domain>;
    /**
     * ```plain
     * 获取当前运行域
     * ```
...
export class Sandbox {
    static "__#12@#topWindow": any;
    static "__#12@#topWindowHTMLElement": any;
    /** @type {WeakMap<Domain, Sandbox>} */
    static "__#12@#domainMap": WeakMap<Domain, Sandbox>;
    /** @type {Array} */
    static "__#12@#executingScope": any[];
    /** @type {WeakMap<Function, string>} */
    static "__#12@#functionRefCodes": WeakMap<Function, string>;
    /**
     * ```plain
     * 检查沙盒操作运行域
     * ```
     ...
     * @param {Sandbox} thiz
     */
    static "__#12@#assertOperator": (thiz: Sandbox) => void;
    /**
     * ```plain
     * 封装沙盒的 Function 函数
     * ```
     ...
     * @param {Window} global
     */
    static "__#12@#initDomainFunctions": (thiz: Sandbox, global: Window) => void;
    /**
     * ```plain
     ...
     * @returns
     */
    static "__#12@#wrappedEval": (thiz: Sandbox, x: any) => any;
    /**
     * ```plain
     * 核心编译函数
     * ```
     ...
     * @returns
     */
    static "__#12@#compileCore": (thiz: Sandbox, code: string, context?: any | null, paramList?: Array<string> | null, inheritScope?: boolean | null, writeContext?: "exists" | "extend" | "all") => (this: any, ...args: any) => any;
    /**
     * ```plain
     * 根据运行域获取沙盒对象
     * ```
     ...
     * @param {Sandbox} thiz
     */
    static "__#12@#createScope": (thiz: Sandbox) => void;
    static "__#12@#makeName": (prefix: string, conflict: any) => string;
    /**
     * @param {Symbol} signal
     * @param  {...any} args
     * @returns
