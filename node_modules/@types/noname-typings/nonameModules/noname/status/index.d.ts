export class status {
    ...
    get event(): import("noname-typings/nonameModules/noname/library/element/gameEvent.js").GameEvent | undefined ;
    set event(event: import("noname-typings/nonameModules/noname/library/element/gameEvent.js").GameEvent);
    rootEvent: GameEvent | undefined;
    tempEvent: GameEvent | undefined;
    ai: {};
    lastdragchange: any[];
    /**
     * @type { string[] }
