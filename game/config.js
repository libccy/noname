window.config = {
	...
	all: {
		sgscharacters: ["standard", "shenhua", "xinghuoliaoyuan", "refresh", "yijiang", "newjiang", "sp", "sp2", "xianding", "huicui", "extra", "old", "mobile", "shiji", "tw", "yingbian", "offline", "jsrg", "sb", "clan", "collab", "onlyOL"],
	...
	characters: ["standard", "shenhua", "sp", "sp2", "yijiang", "newjiang", "refresh", "xinghuoliaoyuan", "mobile", "extra", "yingbian", "sb", "tw", "offline", "clan", "collab", "xianding", "huicui", "shiji", "jsrg", "onlyOL"],
	moderned_chracters: ["standard", "shenhua", "sp", "sp2", "yijiang", "newjiang", "refresh", "xinghuoliaoyuan", "mobile", "extra", "yingbian", "sb", "tw", "offline", "clan", "collab", "xianding", "huicui", "shiji", "onlyOL", "jsrg", "old", "diy", "ddd", "key"],
